...
- Click on "Add an Account" (Since we have already one named sandbox1 in our aws account, just show how to create for students. )
...
### Step 3 - Creating  SCPs to Prevent Using Another Region
...
Tag key : Department
  Tag key options:
    ...
    Tag value compliance              : Checked >>>>> Specify values >>> aws,  devops >>> save changes

    Resource types to enforce         : Checked >>>>> Specify resource types >>> Dynamodb >>> save changes
```
- Create Policy 
