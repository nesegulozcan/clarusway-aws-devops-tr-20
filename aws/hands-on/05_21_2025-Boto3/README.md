...
# Create a new bucket
s3.create_bucket(Bucket='betuls-boto3-bucket') # Change your bucket Name
...
s3.Bucket('betuls-boto3-bucket').put_object(Key='test.jpg', Body=data) # Change your bucket Name
```
- Check the "betuls-boto3-bucket", if your script works fine, you should be able to see your test file in your bucket.

- aws s3 ls s3://betuls-boto3-bucket    # Change your bucket Name
