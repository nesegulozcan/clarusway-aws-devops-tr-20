...
```text
Bucket name                 : myfirstbucket-betul-01(instead of "betul", students use their  own clarusway student number)
Region                      : N.Virginia
...
- Upload `cat2.jpg` and `cat3.jpg` files under `myfirstbucket-betul-01` bucket.
