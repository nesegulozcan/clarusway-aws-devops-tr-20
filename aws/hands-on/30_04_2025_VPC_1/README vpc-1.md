...
- create a vpc named "clarus-vpc" with `10.7.0.0/16` CIDR
    - no ipv6 CIDR block
    - tenancy: default
...
- enable DNS hostnames for the vpc 'clarus-vpc'

  - select 'clarus-vpc' on VPC console ----> Actions ----> Edit VPC settings 
...
-  attach the internet gateway 'clarus-igw' to the vpc 'clarus-vpc'
  - Actions ---> attach to VPC
  - Select VPC named "clarus-vpc"
...
- rename the route table of the vpc 'clarus-vpc' as 'clarus-default-rt'
