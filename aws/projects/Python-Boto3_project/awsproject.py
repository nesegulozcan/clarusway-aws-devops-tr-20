...
"""
Define the tag-key values which will determine if the instance needs to be start or stopped. 
If the instance doesn't have these tags, the scheduler will ignore the instance.
"""
...
"""
Return a list of all of the instances that have the key specified.
"""
...
Decide what to do with an instance, given the instance state and current time:
    ...
    - in all other cases, leave the instance as it is
"""
...
def lambda_handler(event, context):
    ...
    try:
        ...
        print(return_status)
        return {"statusCode" : return_code, "body": json.dumps(return_status)} # https://docs.aws.amazon.com/lambda/latest/dg/python-handler.html?utm_source=chatgpt.com
...
"""
tags = [
    {'Key': 'SchedulerStartTime', 'Value': '8'},
    {'Key': 'Name', 'Value': 'betul-scheduled-server'}
    {'Key': 'SchedulerStopTime', 'Value': '18'}
]
"""